...
class EventFactory:
    ...
    def create_event(
        ...
        accounting_enabled = (
            accounting_entries is not None and len(accounting_entries) > 0
        )
    ...
    def _compute_event_hash(
        self, event_type: str, payload: Dict[str, Any], source: Dict[str, Any]
    ) -> str:
    ...
    def generate_idempotency_key(
        self, event_type: str, entity_id: str, action: str
    ) -> str:
