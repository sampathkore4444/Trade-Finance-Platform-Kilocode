...
class EventSource:
    ...
    def __init__(self, service: str, actor: str, actor_id: Optional[str] = None):
        self.service = service
        self.actor = actor
        self.actor_id = actor_id

    def to_dict(self) -> dict:
        return {"service": self.service, "actor": self.actor, "actor_id": self.actor_id}
...
class Event(Base):
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "accounting": (
                {"enabled": self.accounting_enabled, "entries": self.accounting_entries}
...
class EventAccountingStatus(Base):
    ...
    # Indexes
    __table_args__ = (Index("idx_accounting_status_retry", "status", "retry_count"),)
